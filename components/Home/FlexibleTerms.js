...
export default function FlexibleTerms() {
  return (
    <div className="p-6 space-y-10 flex flex-col-reverse md:flex-row-reverse items-center justify-between">
      <section className="w-full md:w-1/2 pt-5">
      ...
      <section className="relative space-y-10">
        ...
        />
        <div className="p-4 text-white bg-blue-500 rounded shadow-black/30 shadow-lg md:absolute top-10 left-56 w-[400px] mx-auto">
